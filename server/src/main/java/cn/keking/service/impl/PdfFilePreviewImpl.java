...
public class PdfFilePreviewImpl implements FilePreview {
	...
	private static final Logger log = LoggerFactory.getLogger(PdfFilePreviewImpl.class);
	...
	public String filePreviewHandle(String url, Model model, FileAttribute fileAttribute) {
		...
		log.info("fileName:{} pdfName:{} outFilePath:{} officePreviewType:{}", fileName, pdfName, outFilePath,
				officePreviewType);
